...
parser.add_argument("--embeddings-dir", type=str, default=os.path.join(models_path, 'embeddings'), help="embeddings directory for textual inversion (default: embeddings)")
...
parser.add_argument("--lora-dir", type=str, help="Path to directory with Lora networks.", default=os.path.join(models_path, 'Lora'))